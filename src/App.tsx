...
export function App() {
  ...
  const renderCurrentView = () => {
    switch (currentRoute) {
      case 'home':
        return <Home problems={problems} ideas={ideas} navigate={navigate} showToast={showToast} />;
      case 'about':
        return <About navigate={navigate} />;
      case 'how':
        return <HowItWorks />;
      case 'explorer':
        return <ProblemExplorer problems={problems} navigate={navigate} />;
      case 'jharkhand':
        return <JharkhandDashboard problems={problems} navigate={navigate} />;
      case 'ideas':
        return <IdeasSolutions ideas={ideas} navigate={navigate} showToast={showToast} />;
      case 'track':
        return <TrackProblem problems={problems} navigate={navigate} />;
      case 'submit':
        return (
          <SubmitProblem
      ...
      case 'leaderboard':
        return <Leaderboard />;
      case 'partners':
        return <Partners navigate={navigate} />;
      case 'login':
      ...
      case 'search':
        return <GlobalSearch problems={problems} ideas={ideas} navigate={navigate} />;
      case 'notifications':
        return <NotificationsView navigate={navigate} showToast={showToast} />;
      case 'dashboard-citizen':
        return <CitizenProfile problems={problems} navigate={navigate} />;
      ...
      case 'dashboard-university':
        return <UniversityDashboard problems={problems} navigate={navigate} />;
      case 'dashboard-industry':
        return <IndustryDashboard ideas={ideas} navigate={navigate} showToast={showToast} />;
      ...
      case 'admin':
        return <AdminDashboard problems={problems} showToast={showToast} />;
      default:
        return <Home problems={problems} ideas={ideas} navigate={navigate} showToast={showToast} />;
    }
  };
